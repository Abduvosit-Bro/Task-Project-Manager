  ...
  if (projects.length === 0) {
    return (
      <div className="text-center py-12 glass-card">
        ...
        <p className="text-slate-500 dark:text-slate-400">Create your first project to get started</p>
      </div>
    )
  }
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {projects.map((project) => (
        <div
          ...
          className="group relative glass-card p-5 hover:shadow-md transition-all duration-300 cursor-pointer flex flex-col justify-between hover:-translate-y-1"
        >
          <div>
